...
export default function ResultGame(props){
    return (
        <div className='h-full w-full flex flex-col justify-center border-2 rounded-xl'>
            ...
            <div className='block'>
            <button onClick={props.startFirstGame} className='border mx-auto w-72 h-28 rounded-md shadow-md  bg-[#CFB69A] hover:bg-[#ac957b] active:bg-[#8a7660]'>
