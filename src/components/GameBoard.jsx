...
export default function GameBoard(props){
    ...
    return (
        <>          
          <div className='grid grid-cols-4 md:grid-cols-5 place-content-center justify-items-center gap-5 md:border rounded-md py-1 px-2 h-fit md:px-20 md:py-10 md:h-full'>
            <Box 
              dices = {props.dices}
